  ...
  return (
    ...
    <Grid container justify="center">
      ...
      <a className="map-region__link"  title="Aosta">
          	<path className="map-region__shape" style={{fill: catColor(andamento[19].totale_casi)}} id="aosta" d="M47.475,80.497l14.763-4.429l7.61,3.805l6.009-4.506l-3.381-15.215
          ...
          <text x="40" y="64"> {andamento[19].totale_casi} </text>
        </g>
          </a>

      <a className="map-region__link"  title="Trentino">
      	<path className="map-region__shape" style={{fill: catColor(andamento[17].totale_casi)}} id="trentino" d="M156.479,47.741l-3.025,6.05l2.961,2.961l-5.265,11.583l1.186,4.152l6.416-2.75l6.943,9.919
          ...
          <text x="170" y="28"> {andamento[17].totale_casi} </text>
        </g>
          </a>

      <a className="map-region__link"  title="Friuli">
          	<path className="map-region__shape" style={{fill: catColor(andamento[6].totale_casi)}} id="friuli" d="M206.241,55.658l5.057,17.698l7.454-3.727l5.382,8.318l0.176-0.112l2.636,0.751
          ...
          <text x="240" y="48"> {andamento[6].totale_casi} </text>
        </g>
          </a>

      <a className="map-region__link"  title="Veneto">
          <path className="map-region__shape" style={{fill: catColor(andamento[20].totale_casi)}} id="veneto" d="M165.827,102.017l4.876-0.976l8.676,8.677l19.328-1.567l8.071,6.829
          ...
          <text x="210" y="88"> {andamento[20].totale_casi} </text>
        </g>
          </a>

      <a className="map-region__link"  title="Piemonte">
          	<path className="map-region__shape" style={{fill: catColor(andamento[12].totale_casi)}} id="piemonte" d="M59.965,138.456c0,0.008-0.004,0.018-0.004,0.027l12.756-1.16l6.961-15.911l26.193-4.366
          ...
          <text x="50" y="108"> {andamento[12].totale_casi} </text>
        </g>
          </a>

      <a className="map-region__link"  title="Lombardia">
          <path className="map-region__shape" style={{fill: catColor(andamento[9].totale_casi)}} id="lombardia" d="M105.98,62.39c0,3.404-0.344,4.987-1.095,4.987l-0.202-0.035
          ...
          <text x="120" y="58"> {andamento[9].totale_casi} </text>
        </g>
          </a>

      <a className="map-region__link"  title="Emilia">
      <path className="map-region__shape" style={{fill: catColor(andamento[5].totale_casi)}} id="emilia" d="M193.606,156.217l7.049-11.078l11.946,10.95c0.952-1.615,1.903-3.262,2.794-4.838
          ...
          <text x="200" y="138"> {andamento[5].totale_casi} </text>
        </g>
          </a>

      <a className="map-region__link" title="Toscana">
          <path className="map-region__shape" style={{fill: catColor(andamento[16].totale_casi)}} id="toscana" d="M172.68,217.116l11.238-15.479l5.53-2.674v-14l8.463-4.322l-5.194-5.104l6.647-12.428
        ...
        <g className="region__badge">
          ...
          <text x="140" y="186"> {andamento[16].totale_casi} </text>
        </g>
          </a>

      <a className="map-region__link"  title="Umbria">
          <polygon className="map-region__shape" style={{fill: catColor(andamento[18].totale_casi)}} id="umbria" points="193.448,187.398 193.448,201.398 191.027,202.503 206.098,213.686 216.312,205.286
         ...
         <g className="region__badge">
          ...
          <text x="190" y="190"> {andamento[18].totale_casi} </text>
        </g>
      	</a>

      <a className="map-region__link"  title="Lazio">
        <path className="map-region__shape" style={{fill: catColor(andamento[7].totale_casi)}} id="lazio" d="M211.049,254.618c3.298,0.533,4.525,1.465,6.536,4.962c1.842,3.205,3.161,4.306,5.158,4.306
          ...
          <text x="200" y="250"> {andamento[7].totale_casi} </text>
        </g>
      	</a>

      	<a className="map-region__link"  title="Marche">
          <path className="map-region__shape" style={{fill: catColor(andamento[10].totale_casi)}} id="marche" d="M241.13,169.508c-0.938-4.454-2.536-5.797-9.733-8.18c-3.382-1.119-6.902-3.358-9.334-5.934
      ...
      <g className="region__badge">
          ...
          <text x="245" y="170"> {andamento[10].totale_casi} </text>
        </g>
      	</a>
      <a className="map-region__link"  title="Abruzzo">
      	<path className="map-region__shape" style={{fill: catColor(andamento[0].totale_casi)}} id="abruzzo" d="M242.392,197.751l-7.894,12.403l-0.443-0.379l-4.361,3.738l7.285,10.16l-6.459,2.981h-3.307
          ...
          <text x="255" y="208"> {andamento[0].totale_casi} </text>
        </g>
      	</a>

          <a className="map-region__link"  title="Molise">
          	<path id="molise" className="map-region__shape" style={{fill: catColor(andamento[11].totale_casi)}} d="M278.606,227.816l-7.565,9.839h-11.038l-7.17,9.21l-1.076,3.711l2.509,2.153l6.835-3.874
          ...
          <text x="285" y="224"> {andamento[11].totale_casi} </text>
        </g>
      	</a>
              <a className="map-region__link"  title="Puglia">
      <path id="puglia" className="map-region__shape" style={{fill: catColor(andamento[13].totale_casi)}} d="M388.014,291.511c-3.125-3.1-6.282-6.963-7.016-8.586c-1.076-2.38-2.046-2.949-5.021-2.949
          ...
          <text x="355" y="274"> {andamento[13].totale_casi} </text>
        </g>
      	</a>
      	        <a className="map-region__link"  title="Sicilia">
      	<path id="sicilia" className="map-region__shape" style={{fill: catColor(andamento[15].totale_casi)}} d="M302.497,380.18c-1.231,0-2.723,0.346-4.195,1.098c-1.389,0.71-3.025,1.15-4.106,1.15
          ...
          <text x="255" y="394"> {andamento[15].totale_casi} </text>
        </g>
      	</a>

      <a className="map-region__link"  title="Basilicata">
      	<path id="basilicata" className="map-region__shape" style={{fill: catColor(andamento[1].totale_casi)}} d="M329.749,283.273l-6.626-9.939l-6.029,1.005l-6.67-10.481l-6.684,4.011l1.713,3.854
          ...
          <text x="320" y="284"> {andamento[1].totale_casi} </text>
        </g>
      	</a>

      <a className="map-region__link"  title="Calabria">
      	<path id="calabria" className="map-region__shape" style={{fill: catColor(andamento[3].totale_casi)}} d="M353.941,341.338c-0.621-7.177-0.927-7.952-3.711-9.374c-1.669-0.852-3.327-2.46-3.684-3.573
          ...
          <text x="310" y="354"> {andamento[3].totale_casi} </text>
        </g>
      	</a>

          <a className="map-region__link"  title="Campania">
          <path id="campania" className="map-region__shape" style={{fill: catColor(andamento[4].totale_casi)}} d="M291.924,263.655l-6.749-11.322l-16.358,5.897l-7.806-4.817l-7.165,4.126l-3.32-2.751
      ...
      <g className="region__badge">
          ...
          <text x="270" y="294"> {andamento[4].totale_casi} </text>
        </g>
      	</a>

          <a className="map-region__link"  title="Liguria">
      	<path id="liguria" className="map-region__shape" style={{fill: catColor(andamento[8].totale_casi)}} d="M132.028,142.814l-9.799-11.977l1.078-0.808l-15.385-4.112l-3.682-4.603l-21.807,3.634
          ...
          <text x="95" y="152"> {andamento[8].totale_casi} </text>
        </g>
      	</a>

          <a className="map-region__link"  title="Sardegna">
      	<path id="sardegna" className="map-region__shape" style={{fill: catColor(andamento[14].totale_casi)}} d="M114.038,274.612c-1.445,0-2.628-0.483-2.628-1.072c0-0.59,0.977-1.073,2.171-1.073
          ...
          <text x="74" y="310"> {andamento[14].totale_casi} </text>
        </g>
      	</a>
      </svg>
      </div>
